  ...
  return (
    <>
      <div className='md:max-w-4xl my-3 px-10 md:px-16'>
        <h3 className='font-bold text-2xl'>Selected Products</h3>
        <p className='py-5'>Discover the latest fashion trends that are designed to make you look and feel at your best</p>
